...
uint8_t broadcastAddress[] = {"C0:49:EF:D1:23:6C"}; // 
...
struct_message dr; // data recieved
...
void OnDataRecv(const uint8_t * mac, const uint8_t *incomingData, int len) {
  memcpy(&dr, incomingData, sizeof(dr));
  Serial.print(dr.t_vx_red);
  Serial.print('\t');
  Serial.println(dr.t_vy_red);
...
void loop() {
  // Mencari v_tw
    int t_vw_1 = dr.t_vy_red - dr.t_vx_red;
    int t_vw_2 = dr.t_vy_red + dr.t_vx_red;
    int t_vw_3 = dr.t_vy_red + dr.t_vx_red;
    int t_vw_4 = dr.t_vy_red - dr.t_vx_red;
  ...
  // Mencari vx dan vy
    ds.vx_red = (vw_1 + vw_2 + vw_3 + vw_4)/4;
    ds.vy_red = (- vw_1 + vw_2 + vw_3 - vw_4)/4;
